<h1>Hi, I'm Nandaganesh 👋</h1>
<h3>🚀 Software Engineer | Full Stack Developer | Cloud & AI Enthusiast</h3>

---

- 🇮🇳 Based in Bangalore, India  
- 👨‍💻 3+ years of experience building scalable, cloud-native applications  
- 🔭 Currently working on **React, Microfrontend Architecture & FastAPI**  
- 🌱 Exploring **AI/ML (LangChain, Gemini, LLMs) & System Design**  
...
<img src="https://raw.githubusercontent.com/kubernetes/kubernetes/master/logo/logo.svg" width="40"/>
...
- 🧩 Built **Microfrontend architecture** using Webpack Module Federation  
- ⚡ Improved performance to **90+ Lighthouse scores**  
- 🤖 Developed **AI-powered test case generation system using LangChain & Gemini**  
- 📊 Built scalable backend services with **FastAPI + BigQuery (GCP)**  
- 🐳 Deployed cloud-native apps using **Docker, Kubernetes & CI/CD pipelines**  

---

<h3 align="left">📜 Certifications:</h3>

- ☁️ Google Cloud Professional Cloud Architect (2025)  
- ☁️ Google Cloud Associate Cloud Engineer (2025)  
- ⚙️ GitHub Actions & Copilot  
...
- Developed Flask APIs for prediction  
- Funded by KSCST & presented at state-level exhibition  
- Accepted at Springer AITCES 2024  

---

<h3 align="center">✨ “Building scalable systems today for a smarter tomorrow.” ✨</h3>
